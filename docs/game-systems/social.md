...
│  │              Shared challenges · Guild ranks                 │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                      │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │                      ACCOUNTABILITY                          │   │
│  │                    1-on-1 partnerships                       │   │
│  │              See each other's daily completion               │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                      │
│  ┌─────────────────────────────────────────────────────────────┐   │
│  │                         SHADOWS                              │   │
│  │              Anonymous comparison ghosts                     │   │
│  │              "Someone at your level completed X"             │   │
│  └─────────────────────────────────────────────────────────────┘   │
│                                                                      │
└─────────────────────────────────────────────────────────────────────┘
```
...
|------|---------|---------|
| **Level Shadow** | Same level ± 2 | "A Level 11 player averaged 12,400 steps this week" |
...
Today:
• 2,341 completed all core quests
• 847 entered dungeons
• 12 defeated bosses
...
Player "████████" wants to share daily progress.

If you accept:
• You see their daily completion status
• They see your daily completion status
• Neither sees specific data (steps, weight, etc.)
...
```
┌─────────────────────────────────────────────────────────────────┐
│  GUILD: The Morning Protocol                                     │
│  Members: 6/10 · Rank: Silver · Season Points: 2,340            │
├─────────────────────────────────────────────────────────────────┤
│                                                                  │
│  TODAY'S COMPLETION                                              │
│  ████████████████████░░░░  83% (5/6 members complete)           │
│                                                                  │
│  MEMBER STATUS                                                   │
│  @alex      [✓✓✓✓]  Done · Streak: 45                          │
│  @jordan    [✓✓✓✓]  Done · Streak: 23                          │
│  @sam       [✓✓✓·]  3/4  · Streak: 12                          │
│  @mike      [✓✓··]  2/4  · Streak: 8                           │
│  @taylor    [✓✓✓✓]  Done · Streak: 67 👑                       │
│  @chris     [····]  0/4  · Streak: 0 (inactive 3 days)         │
│                                                                  │
│  GUILD CHALLENGE: Morning Dominance                              │
│  All members complete workout before 8am · Progress: 2/5 days   │
│  Reward: 500 XP per member                                       │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
```
...
─────────────────────────────────────────────────
1     The Dawn Collective      12,450    ████████████
2     Iron Protocol            11,200    ███████████
3     Morning Dominance        10,890    ███████████
...
47    The Morning Protocol      2,340    █████
```
...
Requirements:
• 3-5 players
• All must be Level 10+
• All must have defeated "The Inconsistent One"
...
Rewards distributed:
• 500 XP per member
• Title: "Raid Survivor" (all members)
• Guild XP: +1000 (if same guild)
